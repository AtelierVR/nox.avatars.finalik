	...
	public class VRIKWeightParameter : IParameter {
		...
		public object Value {
			...
			set {
				...
				switch (_group, _type) {
					case (HumanBodyBonesGroup.Head, WeightType.Position):
						_rig.solver.spine.positionWeight = w;
						break;
					case (HumanBodyBonesGroup.Head, WeightType.Rotation):
						_rig.solver.spine.rotationWeight = w;
						break;

					case (HumanBodyBonesGroup.LeftArm, WeightType.Position):
						_rig.solver.leftArm.positionWeight = w;
						break;
					case (HumanBodyBonesGroup.LeftArm, WeightType.Rotation):
						_rig.solver.leftArm.rotationWeight = w;
						break;

					case (HumanBodyBonesGroup.RightArm, WeightType.Position):
						_rig.solver.rightArm.positionWeight = w;
						break;
					case (HumanBodyBonesGroup.RightArm, WeightType.Rotation):
						_rig.solver.rightArm.rotationWeight = w;
						break;

					case (HumanBodyBonesGroup.LeftLeg, WeightType.Position):
						_rig.solver.leftLeg.positionWeight = w;
						break;
					case (HumanBodyBonesGroup.LeftLeg, WeightType.Rotation):
						_rig.solver.leftLeg.rotationWeight = w;
						break;

					case (HumanBodyBonesGroup.RightLeg, WeightType.Position):
						_rig.solver.rightLeg.positionWeight = w;
						break;
					case (HumanBodyBonesGroup.RightLeg, WeightType.Rotation):
						_rig.solver.rightLeg.rotationWeight = w;
						break;
				}
			}
		}
